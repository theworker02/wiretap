...
**Evidence-backed binary protocol inference Ã¢â‚¬â€ offline, deterministic, explainable**
...
Built by **[@theworker02](https://github.com/theworker02)** Ã¢â‚¬â€ independent tooling for
...
Module docs: [pkg.go.dev/github.com/theworker02/wiretap](https://pkg.go.dev/github.com/theworker02/wiretap) Ã‚Â· pinned: [@v0.5.0](https://pkg.go.dev/github.com/theworker02/wiretap@v0.5.0) Ã‚Â· [GitHub Release](https://github.com/theworker02/wiretap/releases/tag/v0.5.0)
...
PowerShell demo: `scripts/demo.ps1` Ã‚Â· Unix: `scripts/demo.sh`
...
**Always distinguished:** observation Ã‚Â· hypothesis Ã‚Â· confidence Ã‚Â· evidence.
...
Module: [`github.com/theworker02/wiretap`](https://pkg.go.dev/github.com/theworker02/wiretap) Ã‚Â· example: [`examples/library`](examples/library)
...
Pipeline stages are first-class Ã¢â‚¬â€ not bolted-on Ã¢â‚¬Å“phases.Ã¢â‚¬Â Budgets (`quick` /
...
- **Authorized use only** Ã¢â‚¬â€ interoperability, debugging, migration, preservation,
authorized research. See [SECURITY.md](SECURITY.md) and
[docs/capture-ethics.md](docs/capture-ethics.md).
- **Acquisition Ã¢â€°Â  analysis** Ã¢â‚¬â€ PCAP/drop-folder helpers load operator-provided
files; they do not MITM or open live sniffers by default.
- **Privacy** Ã¢â‚¬â€ offline, no telemetry, no cloud model calls.
...
- Brand: [docs/brand.md](docs/brand.md) Ã‚Â· assets: [assets/](assets/)
...
Funding: [GitHub Sponsors](https://github.com/sponsors/theworker02) Ã‚Â·
[thanks.dev](https://thanks.dev/u/gh/theworker02) Ã‚Â·
...
FPR ~0.17, recall 1.0 Ã¢â‚¬â€ see [docs/eval.md](docs/eval.md) and [CHANGELOG.md](CHANGELOG.md).
